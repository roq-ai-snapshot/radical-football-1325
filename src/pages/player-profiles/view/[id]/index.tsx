            ...
            <Box>
              {hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Flex alignItems="center" mb={4}>
                  <Text fontSize="lg" fontWeight="bold" as="span">
                    User Player Profile User Id Touser:
                  </Text>
                  <Text fontSize="md" as="span" ml={3}>
                    <Link as={NextLink} href={`/users/view/${data?.user_player_profile_user_idTouser?.id}`}>
                      {data?.user_player_profile_user_idTouser?.email}
                    </Link>
                  </Text>
                </Flex>
              )}
